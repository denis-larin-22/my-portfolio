...
export const Projects = () => {
    ...
    return (
        <section id="projects" className="min-h-fit sm:min-h-screen my-[9em]">
            <div className="relative flex justify-center items-center">
                ...
                <motion.div
                    className="absolute xsm:top-0 top-[10%] z-0 border-[5px] border-light-green px-[11.1em] py-[3.3em]"
                    animate={{
